...
const CallToAction = () => {
    return (
        <section className='calltoaction relative w-full h-svh max-h-[636px] flex flex-col items-center justify-center' id='cta'>
            <Image src='/group1.png' alt="Logo Image" className=" absolute w-full h-2/3 -z-0 " width={1500} height={500} />
